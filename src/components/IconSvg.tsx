...
interface IconSvgElement extends IconSvgProps {
  name: string;
}

export function IconSvg({ name, ...props }: IconSvgElement) {
  const key = name
...
export function ExternalLink(props: IconSvgProps) {
...
export function LiveLink(props: IconSvgProps) {
...
export function MapPin(props: IconSvgProps) {
